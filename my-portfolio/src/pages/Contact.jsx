...
const Contact = () => {
  const socialLinks = [
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/josivantarcio/',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="bg-white p-8 rounded-lg shadow-md">
              <h2 className="text-2xl font-semibold mb-6">Conecte-se Comigo</h2>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <a href="mailto:seu-email@exemplo.com" className="text-gray-800 hover:text-blue-600">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-gray-800">Fortaleza, CE - Brasil</span>
                </div>
              </div>
            </div>
          </div>
